...
import DisplayImage from '../assets/images/product_image_one.png';
                            ...
                            <div className="flex gap-6 flex-wrap">
                                <div className="w-1/2">
                                    ...
                                    <div className="overflow-hidden flex w-[400px] gap-4 mt-5">
                                        ...
                                        <img src={SmallPreviewTwo} className = "w-[22%]" alt="" />
                                        <img src={SmallPreviewThree} className = "w-[22%]" alt="" />
                                        <img src={SmallPreviewFour} className = "w-[22%]" alt="" />
                                        <img src={SmallPreviewFive} className = "w-[22%]" alt="" />
                                        <img src={SmallPreviewSix} className = "w-[22%]" alt="" />
                                        <img src={SmallPreviewSeven} className = "w-[22%]" alt="" />
                                    </div>
                                ...
                                <div className="">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <div className="mt-3 flex items-center gap-3 border-b pb-4">
                                            <p className="text-secondary-200 text-open_sans text-4xl">$49.00</p>
                                            <p className="text-secondary-200 text-4xl opacity-60 line-through">$65.00</p>
                                        </div>
